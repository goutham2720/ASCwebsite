<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="productDetailsPage.aspx.cs" Inherits="ASCwebsite.WebForm6" %>
                ...
                <div class="row row-cols-2">
                    <div class="col col-lg-4 col-md-12  p-3">
                        ...
                        <div class="text-center">
                            <asp:Button class="btn btn-warning mx-2  my-1" ID="AddCartButton" runat="server" Text="ADD TO CART" Width="150" OnClick="AddCartButton_Click" />

                            <asp:Button class="btn btn-success mx-2 my-1" ID="BuyNowButton" runat="server" Text="BUY NOW" Width="150" OnClick="BuyNowButton_Click" />
                        </div>
                    </div>
                    <div class="col col-lg-7  col-md-12  p-3 mx-1 my-3 shadow">
                        ...
                        <h4>&#8377
                            <asp:Label ID="productPriceLabel" runat="server" Text="Label"></asp:Label>
                        </h4>
                        <div class="row">
